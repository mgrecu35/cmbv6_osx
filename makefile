...
#---Compilers
CC =gcc -fPIC -g -I/src_c
CPP=gcc -fPIC -g
F90=gfortran -c -g -fPIC
F77=gfortran -c -g -fPIC
...
LIB =	-L$(HDF5_LIB) \
	...
	-L$(TKIO)/lib \
	-Llapack-3.4.1\
	-Lflann/lib -Lmultiscatter-1.2.10/lib \
...
#---Compile Stages
OBJ =	ensFilter.o readTables_nonsph.o fModelFortran.NUBF.o  random.o nbin.o  cloud.o geophysEns.o gEnv.o fhb1_noNaN.o lut_routines_sjm.o emissModule.o rterain.o radtran_tau_dble.o band_dble.o retTablesInt.half.o testStruct.o absorb.o gcloud.o  juliaFortran.o multiscatter2_ascii.o rosen.o bisection.o dboux.o ezlhconv.o readNh.o

OBJEXE	=    $(OBJ) 

#---Link and create Executable
combAlg.so:	$(OBJEXE) 
		gfortran  -shared $(OPENMPF) -o \
		combAlg.so \
		$(OBJEXE)  $(LIB) $(LIBES) -lc -lstdc++ -lmultiscatter
...
testStruct.o:	src_c/testStruct.c
		$(CC) -c -O2 src_c/testStruct.c
...
juliaFortran.o:	src_f90/juliaFortran.f90
		$(F90) -c $(FOPTS) src_f90/juliaFortran.f90
