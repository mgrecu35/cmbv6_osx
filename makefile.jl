...
#---Compile Stages
OBJ =	ensFilter.o readTables_nonsph.o fModelFortran.NUBF.o  random.o nbin.o  cloud.o geophysEns.o gEnv.o fhb1_noNaN.o lut_routines_sjm.o emissModule.o rterain.o radtran_tau_dble.o band_dble.o retTablesInt.half.o testStruct.o absorb.o gcloud.o  juliaFortran.o

OBJEXE	=    $(OBJ) 

#---Link and create Executable
combAlg.so:	$(OBJEXE) 
		gcc  -shared $(OPENMPF) -o \
		combAlg.so \
		$(OBJEXE)  $(LIB) $(LIBES) -lc -lgfortran
...
radarRet.o:	src_f90/radarRet.f90 				
		$(F90) -c  -O0 -openmp src_f90/radarRet.f90 

radarRet_P1.o:	src_f90/radarRet_P1.f90 				
		$(F90) -c  -O0 -openmp src_f90/radarRet_P1.f90 
...
radarRet.Empty.o:	src_f90/radarRet.Empty.f90 				
		$(F90) -c  -O2 -openmp src_f90/radarRet.Empty.f90 
